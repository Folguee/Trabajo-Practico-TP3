  ...
  return (
    <View className="flex-1 bg-gray-50 dark:bg-gray-900">
      ...
      <ScrollView className="flex-1 px-6 pt-6">
        ...
        <View className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm shadow-slate-200 dark:shadow-none dark:border dark:border-gray-700 mb-4 flex-row items-center justify-between">
          <View className="flex-row items-center gap-3">
            ...
            <View>
              ...
              <Text className="text-slate-800 dark:text-gray-100 font-semibold">{startDate}</Text>
            </View>
          </View>
          <TouchableOpacity>
        ...
        <View className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm shadow-slate-200 dark:shadow-none dark:border dark:border-gray-700 mb-8 flex-row items-center justify-between">
          <View className="flex-row items-center gap-3">
            <View className="bg-slate-100 dark:bg-gray-700 p-3 rounded-full">
              <Calendar size={20} color="#0f172a" />
            </View>
            <View>
              ...
              <Text className="text-slate-800 dark:text-gray-100 font-semibold">{endDate}</Text>
            </View>
          </View>
          <TouchableOpacity>
            <Text className="text-indigo-600 font-medium">Cambiar</Text>
